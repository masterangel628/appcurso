            ...
            let app = new Vue({
                ...
                methods: {
                    ...
                    seleccionar: function (cli) {
                        ...
                        this.txtcele = cli.persona.celper;
                        this.txtdire = cli.persona.dirper;
                        this.txtcore = cli.persona.correoper;
                        this.idper = cli.persona.idpersona;
                        this.cbodepe = cli.persona.distrito.provincia.departamento.iddepartamento;
                        this.suportprovincia(this.cbodepe);
                        this.cboprove = cli.persona.distrito.provincia.idprovincia;
                        this.suportdistrito(this.cboprove);
                        this.cbodiste = cli.persona.distrito.iddistrito;
                    },
                },
            });
        </script>
